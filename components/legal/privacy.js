            ...
            <main className="max-w-full flex-1 relative overflow-y-auto focus:outline-none">
                ...
                <div className="max-w-6xl m-8 md:m-auto lg:m-auto xl:m-auto pt-12 pb-12">
                    <div className="terms">
                        ...
                        and other information we collect and obtain, and how you can contact us if you have any
                        questions or concerns. It is our sincere hope that by explaining our data handling
                        ...
                        <ul>
                            ...
                            <li>When you interact with Credmark. </li>
                            <li>
                                Through services provided to us or you by our affinity partners, third-party
                                companies, agents or contractors.{" "}
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li>
                                ...
                                Credmark or any third party; or{" "}
                            </li>
                            <li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                purchases, IP address and date and time of visit;{" "}
                            </li>
                            <li>
                                Usage details and information, including how you communicate with other users of the
                                Credmark Services;{" "}
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                version, unique device identifiers, browser type, language, wireless network, and
                        ...
                        Certain web transactions may also involve you calling us or our calling you. Please be
                        ...
                        <br />
                        <br />
                        <strong>We do Not Engage in Automated Decision-Making without Human Intervention</strong>
                        <br />
                        <br />
                        ...
                        we believe you would find valuable.
                        <br />
                        <br />
                        <strong> Use of Cookies and Other Tracking Technologies.</strong>
                        <br />
                        ...
                        <ul>
                            <li>
                                ...
                                access certain parts of the Site. Unless you have adjusted your browser setting so
                                that it will refuse cookies, our system will issue cookies when you direct your
                                browser to the Site.{" "}
                            </li>
                            <li>
                                Pixels and Tags. Pixels and tags are site instrumentation tools that help us to
                                determine, for instance, whether a page has been viewed or not and, if so, how many
                                times. Emails or electronic newsletters we send may use tools (e.g., pixel tags or web
                                beacons) to gather email metrics and information to improve the reader’s experience
                                such as how many of the emails are opened, if they were printed or forwarded, the type
                                of device (e.g., mobile or PC) from which they were opened, and the associated member
                                account details, which include name, city, state, and county associated with the
                                applicable IP address. In general, any electronic image viewed as part of a webpage,
                                including an ad banner, can act as a web beacon.
                            </li>
                            <li>
                                Session Logs. Session logs help us determine how people travel through the Site. In
                                this way, we can structure our pages so that the information most frequently visited
                                is easier to find. By tracking page visits, we can also determine if the information
                                we’re providing is being used. The only data gathered is the Internet Protocol (IP)
                                address from which you came (which contains no personal data), the website that
                        ...
                        <br />
                        <br />
                        Your web browser may offer you a “Do Not Track” option, which allows you to signal to
                        operators of websites and web applications and services (including behavioral advertising
                        services) that you do not wish such operators to track certain of your online activities
                        over time and across different websites. We do not honor any web browser “Do Not Track”
                        signals or other mechanisms that provide you with the ability to exercise choice regarding
                        the collection of personally identifiable information about your online activities over
                        time and across third-party websites or online services. At present, no universally
                        accepted standards exist on how companies should respond to do-not-track signals. In the
                        event a final universally accepted standard is established, we will assess and provide an
                        appropriate response to these signals.
                        <br />
                        <br />
                        <strong>Third-Party Responsibilities and Services. </strong>
                        <br />
                        <br />
                        We may use or partner with third-parties, agents or contractors for various purposes in
                        connection with our business and operations (collectively, “Service Providers”), including
                        billing, payment services and the performance of services on our behalf, such as gathering
                        and analyzing information and the provision of services to you. In the course of
                        performing these responsibilities and providing such services, these other companies may
                        have access to your personal data. We may also share information, including your personal
                        data, with these Services Providers in order to enable them to perform these
                        responsibilities and to provide these services. Many Services Providers have adopted their
                        own privacy policies, which are not subject to control by Credmark. You should always
                        ...
                        on ads that appear on or through the Service. Also, if you click on a link to a
                        third-party website, such third party may also transmit cookies to you and we do not have
                        any control over that. Please be aware that cookies placed by third parties may continue
                        to track your activities online even after you are no longer using any our Credmark
                        Services, and those third parties may not honor “Do Not Track” requests you have set using
                        your web browser.
                        <br />
                        <br />
                        Credmark may receive compensation from these Service Providers and other third
                        parties.
                        <br />
                        <br />
                        <strong>
                        ...
                        collected through the use of Google Analytics with personally identifiable information.
                        Although Google Analytics plants a permanent cookie on your web browser to identify you as
                        a unique user the next time you visit the Site, the cookie cannot be used by anyone but
                        Google. Google’s ability to use and share information collected by Google Analytics about
                        your visits to this site is restricted by the Google Analytics Terms of Use and the Google
                        Privacy Policy. You can prevent Google Analytics from recognizing you on return visits to
                        ...
                        <br />
                        <br />
                        We will only use information that we collect about you or that you provide to us,
                        ...
                        <ul>
                            ...
                            <li>
                                To confirm your identity in connection with the use of the Credmark Services.
                            </li>
                            <li>To process and complete transactions and send you related information.</li>
                            <li>To provide technical and other support to you.</li>
                            <li>
                                To send you promotional communications, such as providing you with information about
                                services, features, surveys, newsletters, offers and events, provided that you have
                                given your consent if required by applicable law.
                            </li>
                            <li>
                                To enable Service Providers to perform certain responsibilities and provide certain
                                services in connection with our business and operations.
                            </li>
                            ...
                            <li>
                                To enable marketing, remarketing and targeted advertising and similar services from us
                                or Service Providers, including direct and indirect marketing and on-line behavioral
                                advertising regarding our own and third-party products and services that we believe
                                may be of interest to you, including advertisement on third party websites, provided
                                you have given your consent if required by applicable law.{" "}
                            </li>
                        ...
                        <br />
                        <ul>
                            <li>Estimate our audience size and better understand usage patterns.</li>
                            <li>
                                Store information about your preferences enabling us to customize Credmark and the Site
                        ...
                        <br />
                        <br />
                        <strong>Storage and Transfer of Your Information</strong>
                        <br />
                        <br />
                        We may store any data or other information that we collect (personal or otherwise)
                        ourselves or in databases and servers owned and maintained by us, our affiliates, agents
                        ...
                        world unless otherwise prohibited by applicable law or agreed by Credmark and you. By
                        ...
                        include any personal data, without restriction.
                        <br />
                        <br />
                        ...
                        <li>
                            To Service Providers we use to support our business as more particularly described in
                            the Third-Party Responsibilities and Services provision above.
                        </li>
                        <li>
                            To a potential or actual buyer, assignee or other successor (including its related
                        ...
                        <ul>
                            ...
                            <li>
                                To enforce or apply the Terms and other agreements, including for billing and
                                collection purposes.{" "}
                            </li>
                            <li>
                                If we believe disclosure is necessary or appropriate to protect the rights, property,
                                or safety of Credmark.{" "}
                            </li>
                        </ul>
                        <br />
                        <br />
                        We may share information that is anonymized or in an aggregated form that does not
                        directly identify you and we may use and share any such information for any purpose
                        without restriction so long as it does not violate the terms of this privacy policy or any
                        applicable law. We will never sell that information but we may share it with our
                        affiliates.
                        <br />
                        <br />
                        <strong>Choices About How We Use and Disclose Your Personal Data</strong>
                        <br />
                        <br />
                        We strive to provide you with choices regarding the personal data you provide to us. We
                        have created mechanisms to provide you with the following control over your personal data:
                        <br />
                        <br />
                        <ul>
                            <li>
                        ...
                        <br />
                        <br />
                        <strong>Our Legal Bases for Handling Your Personal Data</strong>
                        GDPR and the laws in some other jurisdictions require companies to tell you about the
                        legal bases that they rely on to use or disclose your personal data. To the extent that
                        those laws apply, we rely on the following legal grounds to process your personal data:
                        <br />
                        <br />
                        <ul>
                            <li>
                            ...
                            <li>
                                Legitimate interests: We may use your personal data information for our legitimate
                                interests on the grounds that it furthers our legitimate interests in commercial
                                activities (but only to the extent that such interests are overridden by the interests
                                or fundamental rights and freedoms of the affected individuals) including:
                            </li>
                            <li>Analyzing and improving the Credmark Services and our business</li>
                            <li>Providing the services pursuant to our contracts with our clients</li>
                            <li>Marketing</li>
                            <li>
                                Legal compliance: We may use and disclose personal data in certain ways to comply with
                                our legal obligations under European or Member State law or other applicable law.
                            </li>
                            <li>
                                Consent: To the extent required by law, and in certain other cases, we handle personal
                                data on the basis of implied or express consent.
                            </li>
                        </ul>
                        <br />
                        <br />
                        ...
                        <br />
                        <br />
                        If you delete your User Content from any of the Credmark Services (including any User
                        ...
                        will usually inform you (before collecting your personal data) if we intend to use your
                        personal data for such purposes or if we intend to disclose your personal data to any
                        third party for such purposes. You can exercise your right to prevent such processing by
                        checking certain boxes on the forms we use to collect your personal data. You can also
                        exercise the right by contacting us directly.
                        <br />
                        <br />
                        If you are an EEA Individual and GDPR applies, and we hold your personal data in our
                        capacity as data controller, you may request that we:
                        <br />
                        <br />
                        Provide access to and/or a copy of certain personal data (including, in some cases, in
                        portable form);
                        <br />
                        <br />
                        Prevent the processing of your personal data for direct-marketing purposes (including any
                        ...
                        <br />
                        <br />
                        Delete certain personal data which we are holding about you; provided that the personal
                        data is not required by us for (i) compliance with a legal obligation under European or
                        Member State law or other applicable law or (ii) the establishment, exercise or defense of
                        a legal claim;
                        <br />
                        <br />
                        ...
                        <br />
                        <br />
                        Restrict the way that we process and disclose certain of your information except to the
                        extent that processing is required (i) to comply with a legal obligation under European
                        Member State law or applicable law or (ii) for the establishment, exercise or defense of
                        legal claims;
                        <br />
                        <br />
                        Transfer your personal data to a third party to the extent that this is technically
                        feasible; and
                        <br />
                        <br />
                        Honor a revocation of your consent for the processing of your personal data (without
                        retroactive effect).
                        <br />
                        <br />
                        We will consider all requests and provide our response within the time period required by
                        ...
                        request you provide us with additional information to confirm your identity before
                        responding to your request. You have the right to lodge a complaint with the authorities
                        applicable to your situation, though we invite you to contact us with any concern, as we
                        would be happy to try to resolve it directly. You may also have the right to make a GDPR
                        complaint to the relevant Supervisory Authority. A list of Supervisory Authorities is
                        available here: https://edpb.europa.eu/about-edpb/board/members_en.
                        <br />
                        <br />
                        If you are an EEA Individual in France, you also have the right to set guidelines for the
                        retention and communication of your personal data after your death.
                        <br />
                        <br />
                        ...
                        <br />
                        <br />
                        We will only retain your personal data, in a form which permits us to identify you, for as
                        long as necessary to fulfil the purposes we collected it for. We will retain and use your
                        personal data as necessary to satisfy any legal, accounting or reporting requirements, to
                        resolve disputes or to enforce our agreements and rights. To dispose of personal data, we
                        may anonymize it, delete it or take other appropriate steps. Data may persist in copies
                        made for backup and business continuity purposes for additional time.
                        <br />
                        <br />
                        <strong>Data Security</strong>
                        <br />
                        <br />
                        We understand that the security of your personal data is important. We provide reasonable
                        administrative, technical, and physical security controls to protect your personal data.
                        ...
                        The date the privacy policy was last updated is identified above. You are responsible for
