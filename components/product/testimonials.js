const testimonials = [
    [
        [
            {
                body: 'Credmark\'s platform allows us to develop DeFi risk models faster than we ever could before. The integration of curated data sets, Python, and a library of pre-built data structures and models are an incredible springboard.',
                author: {
        ...
        [
            {
                body: 'We started using Credmark\'s Token API and then needed some custom portfolio calculations. Credmark was able to build and deploy those in days. Thanks to their DeFi API we were able to immediately integrate that new data into our app.',
                author: {
                    name: 'Daniel Tse, CTO',
                    company: 'Picante',
                                            ...
                                            {column.map((testimonial) => (
                                                ...
                                                >
                                                    <div className="grid grid-cols-1 lg:grid-cols-3">
                                                        <div className="lg:col-span-1 py-5 lg:pr-5 lg:m-auto">
