                    ...
                    <div className="space-y-4 sm:space-y-0 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 py-16">
                        <div className="bg-white p-4 lg:p-24 border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200 shadow-lg">
                            <div>
                                ...
                                <p className="texl-lg font-bold">Easy access to current and historical token prices, liquidity, holdings, and token metadata.</p>
                            </div>
                            <div className="grid lg:grid-cols-2 pb-20">
                                ...
                                <div className="lg:ml-5">
                                    <p className="text-2xl text-lightpurple font-bold pt-9">Liquidity (coming soon)</p>
                                ...
                                <div className="lg:pr-5">
                                    <p className="text-2xl text-lightpurple font-bold pt-9">Holdings (coming soon)</p>
                                    <p className="text-base">
                                ...
                                <div className="lg:pl-5">
                                    <p className="text-2xl text-lightpurple font-bold pt-9">Metadata (coming soon)</p>
                                    <p className="text-base">
                            ...
                            <div className="rounded-md applicationsBg mt-16 py-5 lg:py-20 p-5">
                                <p className="openSansMedium uppercase text-white text-center font-bold text-3xl pb-2 lg:pb-8">Start using the Token API</p>
