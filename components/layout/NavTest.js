                                            ...
                                            <Menu as="div" className="ml-3 relative">
                                                <div>
                                                    <Menu.Button>
                                                        ...
                                                        <div className="mx-5 border-transparent inline-flex items-center px-1 pt-1 border-b-2">
                                                            <Link
                                                                href="/contributors"
                                                            >
                                                               <p className="text-white text-sm"> Contributors</p>
                                                            </Link>
                                                        </div>
                                                        ...
                                                        <a
                                                            ...
                                                            <button
                                                                type="button"
                                                                className="transform hover:scale-110 ml-5 px-5 uppercase mt-5 inline-flex items-center px-4 py-2 shadow-sm text-sm font-medium rounded-md text-white bg-green focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                                            >
                                                                APP
                                                            </button>
                                                        </a>
