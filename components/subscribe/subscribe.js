                        ...
                        <div className="pb-10 max-w-4xl mx-auto block">
                            ...
                            <div className="flex justify-center">
                                <Link href="https://credmark.us19.list-manage.com/subscribe?u=b6dfe393113892a064b435044&id=c295a3edd2" rel="noreferrer">
                                    <button
                                        type="button"
                                        className="workSans flex justify-center text-white font-semibold mt-5 items-center px-8 py-2 shadow-sm text-sm font-medium rounded-md text-credmarkpurple bg-green"
                                    >
                                        Sign-up
                                        <img className="pt-0.5 pl-2" alt="arrow right" src="../assets/arrow.svg" />
                                    </button>
