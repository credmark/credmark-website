          ...
          <div className="px-5 pb-15">
            <div className="pb-10">
              <p className="text-white font-bold text-3xl">
                Sign up for our newsletter for the latest product updates,
                partnerships, and more.
              </p>
              <div className="flex justify-center md:text-left md:block"></div>
              <Link
                href="https://credmark.us19.list-manage.com/subscribe?u=b6dfe393113892a064b435044&id=c295a3edd2"
                rel="noreferrer"
              >
                <button
                  type="button"
      ...
      <div className="bg-black py-10 md:py-20 hidden md:block">
        <div className="max-w-7xl block m-auto">
          <div className="px-5 pb-15 text-center">
            ...
            <p className="text-white">Sign up for our free Token API</p>
            ...
            <h3 className="text-white mt-5 pt-5">Get the latest news</h3>
            <div className="flex justify-center">
              <Link
                href="https://credmark.us19.list-manage.com/subscribe?u=b6dfe393113892a064b435044&id=c295a3edd2"
                rel="noreferrer"
