    ...
    return (
        <>
                    <div className="box col-xs pt-10 transform hover:scale-105 px-5 rounded-md">
                        ...
                        <a href={props.link} target="_blank" rel="noreferrer"><p className="px-5 cursor-pointer text-black text-sm flex pb-6">Read more<img className="pt-1 pl-2" alt="arrow right" src="../assets/arrow.svg" /></p></a>
                    </div>
                    </div>
        </>
    );
