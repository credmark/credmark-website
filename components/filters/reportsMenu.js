        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 block m-auto">
            {
                menuItem.map((item) => {
                    ...
                    return <div key={item.id}>
                        <div className="cusor-pointer border-2 border-credmarkpurple rounded-lg text-center mb-10 py-10 md:mx-5 md:pt-10 transform hover:scale-105">
                            <a href={item.url} target="_blank" rel="noreferrer">
                                <p className="text-left text-black pl-5 text-2xl pt-2.5">{item.type}</p>
